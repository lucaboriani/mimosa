<div class="w-full {width ? width : ' lg:w-1/3' }   flex flex-col lg:flex-row   card">
    ...
    <div class="px-4 py-4 flex flex-col h-full  lg:mx-4  mb-4 ml-4 mr-4  { bgColor ? bgColor :'bg-gray-0'} card-content justify-center">
        ...
        {/if}
        {#if price}
        <p class="text-md  { pTextColor ? pTextColor : ' text-gray-500' } text-right pt-9 mt-auto">
